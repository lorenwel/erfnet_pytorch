...
def main(args):
    ...
    loader = DataLoader(self_supervised_power(args.datadir, input_transform_cityscapes, target_transform_cityscapes, subset=args.subset),
    ...
    for step, (images, labels, filename, filenameGt) in enumerate(loader):
        ...
        filenameSave = "./save_color/" + filename[0].split(args.subset + "/")[1]
